...
public class RoboBombardeiro extends RoboAereo implements Explosivos, Autonomo {
    ...
    public RoboBombardeiro(Ambiente ambiente, String nome, int posX, int posY, int posZ, int altitudeMaxima, int capacidadeBombas, ModuloComunicacao comunicacao, GerenciadorSensores gerenciadorSensores, ControleMovimento controleMovimento) {
        super(ambiente, nome, posX, posY, posZ, altitudeMaxima, comunicacao, gerenciadorSensores, controleMovimento);
        this.bombas = 0;
