...
public class Teste {
    public static void main(String[] args) {
        ...
        SensorAltitude sensorAltitude80 = new SensorAltitude(80);
        SensorAltitude sensorAltitude40 = new SensorAltitude(40);
        ...
        while(true){
            System.out.println("Digite o comando que será realizado:\n" +
                    ...
                    "[2] - Remover Sensor de um robô\n" +
                    "[3] - Comandar um robo para monitorar seu arredor\n" +
                    "[4] - Comandar um robo para mover-se\n" +
                    "[5] - Usar habilidade específica da classe de robô\n" +
                    "[6] - Finalizar o programa");
            int comando = scanner.nextInt(); scanner.nextLine();
            ...
            switch (comando){
                case 1:
                    ...
                    System.out.println("Digite o tipo de sensor que deseja adicionar. Opções:\n" +
                            ...
                            "[5] - SensorClasse50\n" +
                            "[6] - SensorClasse100");
                    int comando2 = scanner.nextInt(); scanner.nextLine();
                    ...
                    switch(comando2){
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            robo.addSensor(sensorAltitude80);
                            break;
                        case 4:
                            robo.addSensor(sensorAltitude40);
                            break;
                        case 5:
                ...
                case 2:
                    System.out.println("Digite o nome do robô que perderá um sensor. Opções: teste1, teste2, teste3, teste4");
                    nomeRobo = scanner.nextLine();
